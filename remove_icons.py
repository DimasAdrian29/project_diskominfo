...
pattern = r'<div class="w-10 h-10 rounded-md bg-[^"]+ text-[^"]+ flex items-center justify-center shrink-0 shadow-sm mt-0\.5">\s*<span class="material-symbols-outlined text-\[20px\]">[^<]+</span>\s*</div>'
